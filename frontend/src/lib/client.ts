...
export function Environment(name: string): BaseURL {
  return `https://${name}-secondapp-9wki.encr.app`;
}
...
/**
 * Client is an API client for the secondapp-9wki Encore application.
 */
...
class BaseClient {
  ...
  constructor(baseURL: string, options: ClientOptions) {
    ...
    this.headers = {
      ...
      "User-Agent": "secondapp-9wki-Generated-TS-Client (Encore/v1.27.0)",
    };
